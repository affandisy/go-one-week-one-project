...
GET	/grades?classId=&subjectId=&componentId=	Get grades for a class/subject/component	Guru
POST	/grades	Enter/update grade for a student	Guru
PATCH	/grades/{id}	Update grade	Guru
GET	/report-cards?studentId=&semester=	Get report card (PDF download)	Murid, Wali, Kepsek
...
POST	/attendance/student	Record student attendance (by wali/guru piket)	Guru
GET	/attendance?userId=&from=&to=	Get attendance records for a user	All (own) / Guru (for students)
GET	/attendance/summary?classId=&month=&year=	Attendance summary for a class	Guru, Wali, Kepsek
...
POST	/salary-payslips/calculate	Trigger payslip calculation for a month	Keuangan
GET	/salary-payslips?teacherId=&month=&year=	View payslips	Teacher (own), Keuangan
...
POST	/student-recommendations/calculate	Trigger recommendation calculation for semester	BK
GET	/student-recommendations?semester=&classId=	Get ranked list of students	Kepsek, BK
